...
{
    public class GroupByPurchaseKeyIdStrategy : IGroupingStrategy
    {
        ...
        {
            var result = selections.SelectMany(s => s.ColorModelMetas.GroupBy(cm => cm.ColorModelGroupKeys.PurchaseKeyId).Select(sg => new SelectionGroup
            {
