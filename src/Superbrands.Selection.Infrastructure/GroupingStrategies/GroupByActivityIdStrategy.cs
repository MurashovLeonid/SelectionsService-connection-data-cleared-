...
{
    public class GroupByActivityIdStrategy : IGroupingStrategy
    {
        ...
        {
            var result = selections.SelectMany(s => s.ColorModelMetas.GroupBy(cm => cm.ColorModelGroupKeys.ActivityId).Select(sg => new SelectionGroup
            {
