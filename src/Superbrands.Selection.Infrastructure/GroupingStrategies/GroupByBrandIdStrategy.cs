...
{
    public class GroupByBrandIdStrategy : IGroupingStrategy
    {
        ...
        {
            var result = selections.SelectMany(s => s.ColorModelMetas.GroupBy(cm => cm.ColorModelGroupKeys.BrandId).Select(sg => new SelectionGroup
            {
