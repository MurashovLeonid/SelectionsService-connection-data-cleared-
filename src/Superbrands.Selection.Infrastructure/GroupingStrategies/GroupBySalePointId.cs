...
{
    public class GroupBySalePointIdStrategy : IGroupingStrategy
    {
        ...
        {
            var result = selections.SelectMany(s => s.ColorModelMetas.GroupBy(cm => cm.ColorModelGroupKeys.SalePointId).Select(sg => new SelectionGroup
            {
